...
#    st.markdown("<h2 style='text-align: center; color: black;'>This Dashboard can be used to optimise Fly Ash Procurement costs for Ultra Tech Cements. </h2>", unsafe_allow_html=True)
    st.markdown("<s1 style='text-align: center; color: black;'>This Dashboard can be used to optimise Fly Ash Procurement costs for Ultra Tech Cements. The modules available in the dashboard are : </s1>", unsafe_allow_html=True)
