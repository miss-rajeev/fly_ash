# -*- coding: utf-8 -*-
"""
Created on Tue Jan 19 14:17:53 2021
...
#                    st.write(d_prim4)
                    ...
                    filter_link=st.selectbox("Select linkage",options=["Existing","Optimal","All"])
                    if filter_link=="All":
                        fig_l2=line_plot2(data_map2,data_map2_o,df_s,df_p,s1,s2,c,n1,n2,c1,c2,cc,nl1,nl2,df_s_e,df_p_e)
                        
                    elif filter_link=="Existing":
                        fig_l2=line_plot1(data_map2,df_s_e,df_p_e,s1,s2,c,n1,n2,c1,c2,nl1)
                
                    elif filter_link=="Optimal":
                       fig_l2=line_plot1(data_map2_o,df_s,df_p,s1,s2,cc,n1,n2,c1,c2,nl2) 
